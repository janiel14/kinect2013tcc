...
{
    class ShoulderCenter
    {
        //Métodos
        public static String entidade = "shoulder_center";
        ...
        public ShoulderCenter(int id, Sessoes sessao, Double X, Double Y, Double Z, int angulo, int tempo,
            int velocidade)
        {
            this.id = id;
            this.sessao = sessao;
